...
namespace xFrame.Examples.StateMachine
{
    ...
    public class StateMachineModuleUsageExample : MonoBehaviour
    {
        ...
        private void Start()
        {
            ...
            _playerStateMachine = _stateMachineService.CreateStateMachine("PlayerSM", context, true);
        ...
        {
            // 模拟输入
            if (Input.GetKeyDown(KeyCode.Space)) _playerStateMachine.ChangeState<PlayerJumpState>();
            ...
            if (Input.GetKeyDown(KeyCode.K)) _playerStateMachine.ChangeState<PlayerDeadState>();
