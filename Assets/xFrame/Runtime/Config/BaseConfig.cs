...
namespace xFrame.Config
{
    ...
    {
        [Header("配置信息 / Config Info")] [Tooltip("配置的标题，用于描述此配置的名称或用途")] [SerializeField]
        private string _title = "";

        [Tooltip("配置的备注，用于详细说明此配置的作用")] [TextArea(2, 5)] [SerializeField]
        ...
        protected virtual void OnValidate()
        {
            ...
            if (Application.isPlaying) NotifyConfigChanged();
        }
