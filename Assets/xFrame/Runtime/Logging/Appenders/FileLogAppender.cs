...
namespace xFrame.Core.Logging.Appenders
{
    ...
    public class FileLogAppender : ILogAppender
    {
        ...
        private void InitializeWriter()
        {
            ...
            {
                UnityEngine.Debug.LogError($"无法初始化文件日志输出器: {ex.Message}");
            }
        }
        ...
        public void WriteLog(LogEntry entry)
        {
            ...
            lock (_lock)
            {
                ...
                {
                    UnityEngine.Debug.LogError($"写入文件日志失败: {ex.Message}");
                }
            }
        }
        ...
        public void Flush()
        {
            lock (_lock)
            {
                ...
                {
                    UnityEngine.Debug.LogError($"刷新文件日志缓冲区失败: {ex.Message}");
                }
            }
        }
        ...
        public void Dispose()
        {
            lock (_lock)
            {
                ...
                {
                    UnityEngine.Debug.LogError($"释放文件日志输出器资源失败: {ex.Message}");
                }
            }
        }
    }
