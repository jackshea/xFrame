...
namespace xFrame.Tests.EditMode.EventBusTests
{
    ...
    public class EventBusTests
    {
        ...
        public void TestEventHandlerPriority()
        {
            ...
            // 订阅不同优先级的处理器
            _eventBus.Subscribe<TestEvent>(e => executionOrder.Add(1), priority: 1);
            _eventBus.Subscribe<TestEvent>(e => executionOrder.Add(0), priority: 0);
            _eventBus.Subscribe<TestEvent>(e => executionOrder.Add(2), priority: 2);
        ...
        {
            // Arrange
            var filter = new TestEventFilter(minLength: 5);
            _eventBus.AddFilter<TestEvent>(filter);
            _eventBus.Subscribe<TestEvent>(OnTestEvent);
        ...
        public void TestEventInterception()
        {
            ...
            _eventBus.AddInterceptor<TestEvent>(interceptor);
            _eventBus.Subscribe<TestEvent>(OnTestEvent);
        ...
        public void TestEventHistory()
        {
            ...
            var historyList = new System.Collections.Generic.List<TestEvent>(history);
