...
namespace xFrame.Tests.Core
{
    ...
    public class CoreLayerIntegrationTests
    {
        ...
        public bool TestCoreInitialization()
        {
            ...
            try
            {
                _runner = GameRunner.CreateSimulated();
                _runner.Run();

                var success = _runner.IsRunning;
        ...
        public bool TestDelayTask()
        {
            ...
            try
            {
                ...
                var delayTime = 0.1f;
                var taskId = scheduler.Delay(delayTime, () => _delayCallbackFired = true);
                ...
                var success = _delayCallbackFired;
        ...
        public bool TestIntervalTask()
        {
            ...
            try
            {
                ...
                var interval = 0.05f; // 50ms
                var taskId = scheduler.Interval(interval, () =>
                {
                ...
                var success = _intervalCallbackCount == 3;
        ...
        public bool TestNextFrameTask()
        {
            ...
            try
            {
                ...
                var taskId = scheduler.NextFrame(() => _nextFrameCallbackFired = true);
                ...
                var success = _nextFrameCallbackFired;
        ...
        public bool TestTaskCancellation()
        {
            ...
            try
            {
                ...
                var taskId = scheduler.Delay(1f, () => _delayCallbackFired = true);
                Console.WriteLine($"创建延迟任务: TaskId={taskId}, Delay=1s");

                // 取消任务
                var cancelResult = scheduler.Cancel(taskId);
                Console.WriteLine($"取消任务结果: {cancelResult}");

                // 模拟一段时间
                SimulateFrames(_runner, 100);

                var success = cancelResult && !_delayCallbackFired;
        ...
        {
            for (var i = 0; i < frameCount; i++) runner.Update();
        }
