...
namespace MessagePack
{
    public partial class MessagePackSerializer
    {
        ...
        /// </summary>
        private static void SerializeSemiGeneric<T>(ref MessagePackWriter writer, object valueObject,
            MessagePackSerializerOptions? options = null)
        {
        ...
        ///     Helper method used by reflection.
        /// </summary>
        private static object? DeserializeSemiGeneric<T>(ref MessagePackReader reader,
            MessagePackSerializerOptions? options = null)
        {
            ...
            internal CompiledMethods(Type type)
            {
                var ti = type.GetTypeInfo();
                {
                    ...
                    var lambda = Expression
                        .Lambda<Func<object?, MessagePackSerializerOptions?, CancellationToken, byte[]>>(body, param1,
                            param2, param3).Compile(PreferInterpretation);
...

                {
                    ...
                    var serialize = GetMethod(nameof(Serialize), type,
                        new[]
                        {
                            typeof(Stream), null, typeof(MessagePackSerializerOptions), typeof(CancellationToken)
                        });
#if ENABLE_IL2CPP
                    this.Serialize_Stream_T_Options_CancellationToken =
 (x, y, z, a) => serialize.Invoke(null, new object[] { x, y, z, a });
#else
                    ...
                    var lambda = Expression
                        .Lambda<Action<Stream, object?, MessagePackSerializerOptions?, CancellationToken>>(body, param1,
                            param2, param3, param4).Compile(PreferInterpretation);
...
#if ENABLE_IL2CPP
                    this.SerializeAsync_Stream_T_Options_CancellationToken =
 (x, y, z, a) => (Task)serialize.Invoke(null, new object[] { x, y, z, a });
#else
                    var param1 = Expression.Parameter(typeof(Stream), "stream");
                    var param2 = Expression.Parameter(typeof(object), "obj");
                    var param3 = Expression.Parameter(typeof(MessagePackSerializerOptions), "options");
                    ...
                    var lambda = Expression
                        .Lambda<Func<Stream, object?, MessagePackSerializerOptions?, CancellationToken, Task>>(body,
                            param1, param2, param3, param4).Compile(PreferInterpretation);
...
#if ENABLE_IL2CPP
                    this.Serialize_IBufferWriter_T_Options_CancellationToken =
 (x, y, z, a) => serialize.Invoke(null, new object[] { x, y, z, a });
#else
                    ...
                    var lambda = Expression
                        .Lambda<Action<IBufferWriter<byte>, object?, MessagePackSerializerOptions?, CancellationToken>>(
                            body, param1, param2, param3, param4).Compile(PreferInterpretation);
...

                {
                    ...
                    var serialize = GetMethod(nameof(SerializeSemiGeneric), type,
                        new[]
                        {
                            typeof(MessagePackWriter).MakeByRefType(), typeof(object),
                            typeof(MessagePackSerializerOptions)
                        });
#if ENABLE_IL2CPP
                    this.Serialize_MessagePackWriter_T_Options =
 (ref MessagePackWriter x, object y, MessagePackSerializerOptions z) => ThrowRefStructNotSupported();
#else
                    Serialize_MessagePackWriter_T_Options =
...

                {
                    ...
                    var deserialize = GetMethod(nameof(DeserializeSemiGeneric), type,
                        new[] { typeof(MessagePackReader).MakeByRefType(), typeof(MessagePackSerializerOptions) });
#if ENABLE_IL2CPP
                    this.Deserialize_MessagePackReader_Options =
 (ref MessagePackReader reader, MessagePackSerializerOptions options) => { ThrowRefStructNotSupported(); return null; };
#else
                    Deserialize_MessagePackReader_Options =
                        (MessagePackReaderDeserialize)deserialize.CreateDelegate(typeof(MessagePackReaderDeserialize));
#endif
                }
...
#if ENABLE_IL2CPP
                    this.Deserialize_Stream_Options_CancellationToken =
 (x, y, z) => deserialize.Invoke(null, new object[] { x, y, z });
#else
                    var param1 = Expression.Parameter(typeof(Stream), "stream");
                    var param2 = Expression.Parameter(typeof(MessagePackSerializerOptions), "options");
                    var param3 = Expression.Parameter(typeof(CancellationToken), "cancellationToken");
...

                {
                    ...
                    var deserialize = GetMethod(nameof(DeserializeObjectAsync), type,
                        new[] { typeof(Stream), typeof(MessagePackSerializerOptions), typeof(CancellationToken) });
#if ENABLE_IL2CPP
                    this.DeserializeAsync_Stream_Options_CancellationToken =
 (x, y, z) => (ValueTask<object>)deserialize.Invoke(null, new object[] { x, y, z });
#else
                    var param1 = Expression.Parameter(typeof(Stream), "stream");
                    var param2 = Expression.Parameter(typeof(MessagePackSerializerOptions), "options");
                    var param3 = Expression.Parameter(typeof(CancellationToken), "cancellationToken");
                    ...
                    var lambda = Expression
                        .Lambda<Func<Stream, MessagePackSerializerOptions?, CancellationToken, ValueTask<object?>>>(
                            body, param1, param2, param3).Compile(PreferInterpretation);
...
#if ENABLE_IL2CPP
                    this.Deserialize_ReadOnlyMemory_Options =
 (x, y, z) => deserialize.Invoke(null, new object[] { x, y, z });
#else
...
#if ENABLE_IL2CPP
                    this.Deserialize_ReadOnlySequence_Options_CancellationToken =
 (x, y, z) => deserialize.Invoke(null, new object[] { x, y, z });
#else
...
#pragma warning disable SA1401 // Fields should be private
            internal readonly Func<object?, MessagePackSerializerOptions?, CancellationToken, byte[]>
                Serialize_T_Options;
