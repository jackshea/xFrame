...
namespace MessagePack
{
        ...
        ref struct MessagePackWriter
    {
        ...
        /// <remarks>
        ///     When <see cref="OldSpec" /> is <see langword="true" />, the msgpack code used is
        ///     <see cref="MessagePackCode.Str8" />, <see cref="MessagePackCode.Str16" /> or <see cref="MessagePackCode.Str32" />
        ///     instead.
        /// </remarks>
        ...
        ///     <para>
        ///         When <see cref="OldSpec" /> is <see langword="true" />, the msgpack code used is
        ///         <see cref="MessagePackCode.Str8" />, <see cref="MessagePackCode.Str16" /> or
        ///         <see cref="MessagePackCode.Str32" /> instead.
        ///     </para>
        /// </remarks>
            ...
            long sourceBytesToCopy)
        {
            ...
            UnsafeUtility.MemMove(destination, source, sourceBytesToCopy);
#else
