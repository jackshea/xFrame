...
namespace MessagePack.Formatters
{
            ...
            MessagePackSerializerOptions options)
        {
            if (reader.IsNil)
                throw MessagePackSerializationException
                    .ThrowUnexpectedNilWhileDeserializing<ValueTuple<T1, T2, T3, T4>>();
    ...
    public sealed class ValueTupleFormatter<T1, T2, T3, T4, T5> : IMessagePackFormatter<ValueTuple<T1, T2, T3, T4, T5>>
    {
            ...
            MessagePackSerializerOptions options)
        {
            if (reader.IsNil)
                throw MessagePackSerializationException
                    .ThrowUnexpectedNilWhileDeserializing<ValueTuple<T1, T2, T3, T4, T5>>();
        ...
        ValueTupleFormatter<T1, T2, T3, T4, T5, T6> : IMessagePackFormatter<ValueTuple<T1, T2, T3, T4, T5, T6>>
    {
            ...
            MessagePackSerializerOptions options)
        {
            if (reader.IsNil)
                throw MessagePackSerializationException
                    .ThrowUnexpectedNilWhileDeserializing<ValueTuple<T1, T2, T3, T4, T5, T6>>();
        ...
        ValueTupleFormatter<T1, T2, T3, T4, T5, T6, T7> : IMessagePackFormatter<ValueTuple<T1, T2, T3, T4, T5, T6, T7>>
    {
            ...
            MessagePackSerializerOptions options)
        {
            if (reader.IsNil)
                throw MessagePackSerializationException
                    .ThrowUnexpectedNilWhileDeserializing<ValueTuple<T1, T2, T3, T4, T5, T6, T7>>();
        ...
        where TRest : struct
    {
            ...
            MessagePackSerializerOptions options)
        {
            if (reader.IsNil)
                throw MessagePackSerializationException
                    .ThrowUnexpectedNilWhileDeserializing<ValueTuple<T1, T2, T3, T4, T5, T6, T7, TRest>>();
