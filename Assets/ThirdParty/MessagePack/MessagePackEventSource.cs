...
namespace MessagePack
{
    ...
    internal class MessagePackEventSource : EventSource
    {
        ...
        [Event(FormatterDynamicallyGeneratedStartEvent, Task = Tasks.FormatterDynamicallyGenerated,
        ...
        [Event(FormatterDynamicallyGeneratedStopEvent, Task = Tasks.FormatterDynamicallyGenerated,
