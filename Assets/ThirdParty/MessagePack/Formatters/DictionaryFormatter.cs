...
namespace MessagePack.Formatters
{
    ...
    public abstract class
        DictionaryFormatterBase<TKey, TValue, TIntermediate, TEnumerator, TDictionary> : IMessagePackFormatter<
        TDictionary?>
    ...
    public sealed class
        GenericReadOnlyDictionaryFormatter<TKey, TValue, TDictionary> : DictionaryFormatterBase<TKey, TValue,
        Dictionary<TKey, TValue>, TDictionary>
        ...
        where TKey : notnull
    {
        ...
        protected override TDictionary Complete(Dictionary<TKey, TValue> intermediateCollection)
        {
            return (TDictionary)(Activator.CreateInstance(typeof(TDictionary), intermediateCollection) ??
                                 throw new InvalidOperationException("Unable to create dictionary instance."));
        }
    }
