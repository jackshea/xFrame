...
{
    /// <summary>
    ///     Singleton version of <see cref="CompositeResolver" />, which can register a collection of formatters and resolvers
    ...
    public class StaticCompositeResolver : IFormatterResolver
    {
        ...
        /// <returns>
        ///     A formatter, if this resolver supplies one for type <typeparamref name="T" />; otherwise
        ///     <see langword="null" />.
        /// </returns>
