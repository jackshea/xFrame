...
namespace MessagePack
{
    ...
    public class MessagePackStreamReader : IDisposable
    {
        ...
        /// <returns>
        ///     A task whose result is the next whole data structure from the stream, or <see langword="null" /> if the stream
        ///     ends.
        ...
        /// <param name="cancellationToken">A cancellation token.</param>
        /// <returns>
        ///     <see langword="true" /> if more data was read; <see langword="false" /> if the end of the stream had already
        ///     been reached.
        /// </returns>
