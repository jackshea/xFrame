...
namespace MessagePack
{
        ...
        ref partial struct MessagePackReader
    {
        ...
        /// </summary>
        /// <returns>
        ///     <see langword="true" /> if the entire structure beginning at the current <see cref="Position" /> is found in
        ///     the <see cref="Sequence" />; <see langword="false" /> otherwise.
        /// </returns>
        /// <remarks>
        ///     The entire primitive is skipped, including content of maps or arrays, or any other type with payloads.
        ///     To get the raw MessagePack sequence that was skipped, use <see cref="ReadRaw()" /> instead.
        ...
        /// <returns>
        ///     <see langword="true" /> if there was sufficient buffer and an array header was found; <see langword="false" />
        ///     if the buffer incompletely describes an array header.
        /// </returns>
        /// <exception cref="MessagePackSerializationException">Thrown if a code other than an array header is encountered.</exception>
        /// <remarks>
        ...
        /// <returns>
        ///     <see langword="true" /> if there was sufficient buffer and a map header was found; <see langword="false" /> if
        ///     the buffer incompletely describes an map header.
        /// </returns>
        /// <exception cref="MessagePackSerializationException">Thrown if a code other than an map header is encountered.</exception>
        /// <remarks>
        ///     When this method returns <see langword="false" /> the position of the reader is left in an undefined position.
        ...
        ///     <see langword="false" /> if the read token is <see cref="MessagePackCode.Nil" /> or the string is not in a
        ///     contiguous span.
        /// </returns>
        /// <remarks>
        ///     Callers should generally be prepared for a <see langword="false" /> result and failover to calling
        ...
        /// <returns>
        ///     <see langword="true" /> if there were enough bytes to read the length of the next string;
