...
namespace Fleck
{
    public class WebSocketConnection : IWebSocketConnection
    {
        ...
        public WebSocketConnection(ISocket socket, Action<IWebSocketConnection> initialize,
            Func<byte[], WebSocketHttpRequest> parseRequest, Func<WebSocketHttpRequest, IHandler> handlerFactory,
        ...
        public void CreateHandler(IEnumerable<byte> data)
        {
            ...
            ConnectionInfo =
                WebSocketConnectionInfo.Create(request, Socket.RemoteIpAddress, Socket.RemotePort, subProtocol);
